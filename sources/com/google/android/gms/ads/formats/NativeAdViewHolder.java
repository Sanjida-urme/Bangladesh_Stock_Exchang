...
public final class NativeAdViewHolder {
    ...
    public NativeAdViewHolder(View view, Map<String, View> map, Map<String, View> map2) {
        ...
        if (view instanceof NativeAdView) {
            zzaiw.m3e("The provided containerView is of type NativeAdView. NativeAdView objects should not be used with NativeAdViewHolder.");
        } else if (zzalq.get(view) != null) {
            zzaiw.m3e("The provided containerView is already in use with another NativeAdViewHolder.");
        } else {
            zzalq.put(view, this);
