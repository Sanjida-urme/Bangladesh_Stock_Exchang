...
public final class zzaw extends zzkq {
    ...
    public final void initialize() {
        synchronized (sLock) {
            if (this.zzaqh) {
                zzaiw.zzco("Mobile ads is initialized already.");
                return;
            }
            this.zzaqh = true;
    ...
    public final void zza(String str, IObjectWrapper iObjectWrapper) {
        if (!TextUtils.isEmpty(str)) {
            zzmq.initialize(this.mContext);
            int booleanValue = ((Boolean) zzbs.zzep().zzd(zzmq.zzbnq)).booleanValue() | ((Boolean) zzbs.zzep().zzd(zzmq.zzbjo)).booleanValue();
            Runnable runnable = null;
            if (((Boolean) zzbs.zzep().zzd(zzmq.zzbjo)).booleanValue()) {
                booleanValue = 1;
                runnable = new zzax(this, (Runnable) zzn.zzx(iObjectWrapper));
            }
            if (booleanValue != 0) {
                zzbs.zzej().zza(this.mContext, this.zzaqi, str, runnable);
            }
        }
    }
    ...
    public final void zzb(IObjectWrapper iObjectWrapper, String str) {
        if (iObjectWrapper == null) {
            zzaiw.m3e("Wrapped context is null. Failed to open debug menu.");
            return;
        }
        Context context = (Context) zzn.zzx(iObjectWrapper);
        if (context == null) {
            zzaiw.m3e("Context is null. Failed to open debug menu.");
            return;
        }
