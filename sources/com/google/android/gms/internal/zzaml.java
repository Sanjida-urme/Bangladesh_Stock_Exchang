...
final class zzaml implements Callable<zzama> {
    ...
    public final /* synthetic */ Object call() throws Exception {
        zzama zzamn = new zzamn(zzamo.zzb(this.val$context, this.zzdiu, this.zzdiv, this.zzdiw, this.zzdix, this.zzbzo, this.zzbyw, this.zzdiy, this.zzdiz, this.zzbyy, this.zzdja));
        zzamn.setWebViewClient(zzbs.zzee().zzb(zzamn, this.zzdix));
