...
public final class zztn {
    ...
    public zztn(JSONObject jSONObject) throws JSONException {
        ...
        if (jSONObject != null) {
            this.zzcbu = jSONObject.optLong("ad_network_timeout_millis", -1);
            zzbs.zzew();
            this.zzcbv = zztv.zza(jSONObject, "click_urls");
            zzbs.zzew();
            this.zzcbw = zztv.zza(jSONObject, "imp_urls");
            zzbs.zzew();
            this.zzcbx = zztv.zza(jSONObject, "nofill_urls");
            zzbs.zzew();
            this.zzcby = zztv.zza(jSONObject, "remote_ping_urls");
            this.zzcbz = jSONObject.optBoolean("render_in_browser", false);
            long optLong = jSONObject.optLong("refresh", -1);
            if (optLong > 0) {
                j = 1000 * optLong;
            }
            this.zzccb = j;
            zzadw zza = zzadw.zza(jSONObject.optJSONArray("rewards"));
            if (zza == null) {
                this.zzccc = null;
                this.zzccd = 0;
            } else {
            ...
            this.zzccg = jSONObject.optBoolean("use_displayed_impression", false);
            this.zzcch = jSONObject.optBoolean("allow_pub_rendered_attribution", false);
            this.zzcci = jSONObject.optBoolean("allow_pub_owned_ad_view", false);
            return;
        }
        this.zzcbu = -1;
        this.zzcbv = null;
