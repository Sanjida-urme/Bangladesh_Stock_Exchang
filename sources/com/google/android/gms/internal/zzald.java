        ...
        if (fArr[0] != 0.0f || fArr[1] != 0.0f || fArr[2] != 0.0f) {
            ...
            switch (this.zzdff.getRotation()) {
                case 1:
                    ...
                    break;
                case 2:
                    SensorManager.remapCoordinateSystem(this.zzdfg, 129, 130, this.zzdfh);
                    break;
                case 3:
                    SensorManager.remapCoordinateSystem(this.zzdfg, 130, 1, this.zzdfh);
                    break;
                default:
    ...
    final void start() {
        if (this.zzdfj == null) {
            ...
            if (defaultSensor == null) {
                zzaiw.m3e("No Sensor of TYPE_ROTATION_VECTOR");
                return;
            }
            ...
            if (!this.zzdfd.registerListener(this, defaultSensor, 0, this.zzdfj)) {
                zzaiw.m3e("SensorManager.registerListener failed.");
                stop();
            }
        }
    }
