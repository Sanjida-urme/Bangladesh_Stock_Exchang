...
public final class zzair {
    ...
    private OnGlobalLayoutListener zzdbq;
    private OnScrollChangedListener zzdbr;

    public zzair(Activity activity, View view, OnGlobalLayoutListener onGlobalLayoutListener, OnScrollChangedListener onScrollChangedListener) {
        this.zzdbn = activity;
        this.mView = view;
