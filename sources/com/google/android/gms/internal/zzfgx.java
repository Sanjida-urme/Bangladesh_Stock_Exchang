...
final class zzfgx extends zzfgu {
    ...
    private static int zza(byte[] bArr, int i, long j, int i2) {
        switch (i2) {
            ...
            case 2:
                return zzfgt.zzi(i, zzfgr.zzb(bArr, j), zzfgr.zzb(bArr, j + 1));
            default:
    ...
    L_0x000d:
        r6 = r4 + r1;
        r4 = com.google.android.gms.internal.zzfgr.zzb(r9, r4);
    ...
    L_0x0022:
        r10 = r5 + r1;
        r3 = com.google.android.gms.internal.zzfgr.zzb(r9, r5);
    ...
    L_0x0046:
        r10 = r5 + r1;
        r5 = com.google.android.gms.internal.zzfgr.zzb(r9, r5);
    ...
    L_0x0074:
        r10 = 0;
        r5 = r7 + r1;
        r10 = com.google.android.gms.internal.zzfgr.zzb(r9, r7);
    ...
    L_0x0086:
        r12 = r12 + -3;
        r7 = r5 + r1;
        r11 = com.google.android.gms.internal.zzfgr.zzb(r9, r5);
    ...
    L_0x0099:
        r10 = r7 + r1;
        r5 = com.google.android.gms.internal.zzfgr.zzb(r9, r7);
        if (r5 > r3) goto L_0x00a9;
    L_0x00a1:
        r5 = r10 + r1;
        r10 = com.google.android.gms.internal.zzfgr.zzb(r9, r10);
        if (r10 <= r3) goto L_0x001f;
    L_0x00a9:
        return r4;
        */
            ...
            if (bArr2.length - i4 >= i3) {
                ...
                while (i3 < length) {
                    ...
                    if (charAt2 < 128 && j < j2) {
                        ...
                        j3 = j + 1;
                        zzfgr.zza(bArr2, j, (byte) ((charAt2 >>> 6) | 960));
                        j = j3 + 1;
                        zzfgr.zza(bArr2, j3, (byte) ((charAt2 & 63) | 128));
                        i3++;
                    } else if ((charAt2 < 55296 || 57343 < charAt2) && j <= j2 - 3) {
                        j3 = j + 1;
                        zzfgr.zza(bArr2, j, (byte) ((charAt2 >>> 12) | 480));
                        j = j3 + 1;
                        zzfgr.zza(bArr2, j3, (byte) (((charAt2 >>> 6) & 63) | 128));
                        j3 = j + 1;
                        ...
                        if (i5 != length) {
                            ...
                            if (Character.isSurrogatePair(charAt2, charAt3)) {
                                ...
                                long j4 = j + 1;
                                zzfgr.zza(bArr2, j, (byte) ((i3 >>> 18) | 240));
                                j = j4 + 1;
                                zzfgr.zza(bArr2, j4, (byte) (((i3 >>> 12) & 63) | 128));
                                j4 = j + 1;
                                zzfgr.zza(bArr2, j, (byte) (((i3 >>> 6) & 63) | 128));
                                j = j4 + 1;
                                zzfgr.zza(bArr2, j4, (byte) ((i3 & 63) | 128));
                                i3 = i5;
                                i3++;
                            }
                        } else {
                    ...
                    zzfgr.zza(bArr2, j, (byte) charAt2);
                    j = j3;
                    i3++;
                }
                return (int) j;
