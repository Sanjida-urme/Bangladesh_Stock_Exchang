...
public abstract class zzzt implements zzahi<Void>, zzzr {
    ...
    final boolean zza(zzaah zzaah, zzzz zzzz) {
        try {
            zzaah.zza(zzzz, new zzaac(this));
            return true;
        } catch (Throwable th) {
            zzaiw.zzc("Could not fetch ad response from ad request service due to an Exception.", th);
