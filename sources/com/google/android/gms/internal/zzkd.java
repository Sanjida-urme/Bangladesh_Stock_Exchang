...
public final class zzkd extends zzed implements zzkb {
    ...
    public final zzku getVideoController() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            zzku = queryLocalInterface instanceof zzku ? (zzku) queryLocalInterface : new zzkw(readStrongBinder);
        }
        zza.recycle();
        return zzku;
    }
    ...
    public final zzkg zzbx() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            zzkg = queryLocalInterface instanceof zzkg ? (zzkg) queryLocalInterface : new zzki(readStrongBinder);
        }
        zza.recycle();
        return zzkg;
    }
