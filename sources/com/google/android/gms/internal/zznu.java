...
public final class zznu extends zzpr implements zzod {
    ...
    public final void performClick(Bundle bundle) {
        synchronized (this.mLock) {
            if (this.zzbsk == null) {
                zzaiw.m3e("Attempt to perform click before content ad initialized.");
                return;
            }
    ...
    public final boolean recordImpression(Bundle bundle) {
        synchronized (this.mLock) {
            if (this.zzbsk == null) {
                zzaiw.m3e("Attempt to record impression before content ad initialized.");
                return false;
            }
            boolean recordImpression = this.zzbsk.recordImpression(bundle);
    ...
    public final void reportTouchEvent(Bundle bundle) {
        synchronized (this.mLock) {
            if (this.zzbsk == null) {
                zzaiw.m3e("Attempt to perform click before app install ad initialized.");
                return;
            }
