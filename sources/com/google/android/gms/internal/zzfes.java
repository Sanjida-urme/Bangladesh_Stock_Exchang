...
final class zzfes implements zzfev {
    ...
    public final <T extends zzffq> T zza(T t, T t2) {
        ...
        if (t == null) {
            ...
            if (obj.zzpat == 0) {
                int i2 = this.zzpco;
                this.zzpco = 0;
                obj.zza(zzfeu.zzpcr, (Object) this, obj);
                obj.zzpcg = zza(obj.zzpcg, obj.zzpcg);
                obj.zzpat = this.zzpco;
                this.zzpco = i2;
            }
            i = obj.zzpat;
        } else {
    ...
    public final Object zza(boolean z, Object obj, Object obj2) {
        this.zzpco = (this.zzpco * 53) + zzfez.zzdc(((Boolean) obj).booleanValue());
        return obj;
    }
    ...
    public final Object zzb(boolean z, Object obj, Object obj2) {
        this.zzpco = (this.zzpco * 53) + ((Integer) obj).intValue();
        return obj;
    }

    public final Object zzc(boolean z, Object obj, Object obj2) {
        this.zzpco = (this.zzpco * 53) + zzfez.zzdd(Double.doubleToLongBits(((Double) obj).doubleValue()));
        return obj;
    }

    public final Object zzd(boolean z, Object obj, Object obj2) {
        this.zzpco = (this.zzpco * 53) + zzfez.zzdd(((Long) obj).longValue());
        return obj;
    }
