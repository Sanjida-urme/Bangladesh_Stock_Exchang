...
final class zzfgt {
    private static final zzfgu zzpfy;

    static {
        Object obj = (zzfgr.zzcwx() && zzfgr.zzcwy()) ? 1 : null;
        zzpfy = obj != null ? new zzfgx() : new zzfgv();
    }

    static int zza(CharSequence charSequence, byte[] bArr, int i, int i2) {
        return zzpfy.zzb(charSequence, bArr, i, i2);
    }
    ...
    public static boolean zzk(byte[] bArr, int i, int i2) {
        return zzpfy.zzb(0, bArr, i, i2) == 0;
    }
