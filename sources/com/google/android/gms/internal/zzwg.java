...
public class zzwg {
    ...
    public final void zza(int i, int i2, int i3, int i4, float f, int i5) {
        try {
            ...
            zzaiw.zzb("Error occured while obtaining screen information.", e);
        }
    }
    ...
    public final void zzb(int i, int i2, int i3, int i4) {
        try {
            ...
            zzaiw.zzb("Error occured while dispatching size change.", e);
        }
    }
    ...
    public final void zzbl(String str) {
        try {
            ...
            zzaiw.zzb("Error occurred while dispatching error event.", e);
        }
    }
    ...
    public final void zzbm(String str) {
        try {
            ...
            zzaiw.zzb("Error occured while dispatching ready Event.", e);
        }
    }
    ...
    public final void zzbn(String str) {
        try {
            ...
            zzaiw.zzb("Error occured while dispatching state change.", e);
        }
    }
    ...
    public final void zzc(int i, int i2, int i3, int i4) {
        try {
            ...
            zzaiw.zzb("Error occured while dispatching default position.", e);
        }
    }
}
