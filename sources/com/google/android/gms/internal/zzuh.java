...
public final class zzuh extends zzed implements zzuf {
    ...
    public final zzuo zzly() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            zzuo = queryLocalInterface instanceof zzuo ? (zzuo) queryLocalInterface : new zzuq(readStrongBinder);
        }
        zza.recycle();
        return zzuo;
    }
    ...
    public final zzur zzlz() throws RemoteException {
        ...
        if (readStrongBinder == null) {
            ...
            zzur = queryLocalInterface instanceof zzur ? (zzur) queryLocalInterface : new zzut(readStrongBinder);
        }
        zza.recycle();
        return zzur;
    }
