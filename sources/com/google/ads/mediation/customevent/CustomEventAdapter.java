...
public final class CustomEventAdapter implements MediationBannerAdapter<CustomEventExtras, CustomEventServerParameters>, MediationInterstitialAdapter<CustomEventExtras, CustomEventServerParameters> {
    ...
    static final class zza implements CustomEventBannerListener {
        ...
        public final void onFailedToReceiveAd() {
            zzaiw.zzbw("Custom event adapter called onFailedToReceiveAd.");
            this.zzhj.onFailedToReceiveAd(this.zzhi, ErrorCode.NO_FILL);
        }
    ...
    class zzb implements CustomEventInterstitialListener {
        ...
        public final void onFailedToReceiveAd() {
            zzaiw.zzbw("Custom event adapter called onFailedToReceiveAd.");
            this.zzhk.onFailedToReceiveAd(this.zzhi, ErrorCode.NO_FILL);
        }
    ...
    public final void requestInterstitialAd(MediationInterstitialListener mediationInterstitialListener, Activity activity, CustomEventServerParameters customEventServerParameters, MediationAdRequest mediationAdRequest, CustomEventExtras customEventExtras) {
        ...
        if (this.zzhh == null) {
            ...
            this.zzhh.requestInterstitialAd(new zzb(this, this, mediationInterstitialListener), activity, customEventServerParameters.label, customEventServerParameters.parameter, mediationAdRequest, customEventExtras == null ? null : customEventExtras.getExtra(customEventServerParameters.label));
        }
    }
