...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0176R.attr.actionBarSize, 16842841};
    ...
    class C01851 extends AnimatorListenerAdapter {
        C01851() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new C01851();
        this.mRemoveActionBarHideOffset = new C01862();
        this.mAddActionBarHideOffset = new C01873();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0176R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0176R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0176R.id.action_bar));
        }
    }
