...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.gravity = -1;
            context = context.obtainStyledAttributes(attributeSet, C0176R.styleable.LinearLayoutCompat_Layout);
            this.weight = context.getFloat(C0176R.styleable.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.gravity = context.getInt(C0176R.styleable.LinearLayoutCompat_Layout_android_layout_gravity, -1);
            context.recycle();
        }
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        context = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0176R.styleable.LinearLayoutCompat, i, 0);
        attributeSet = context.getInt(C0176R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (attributeSet >= null) {
            setOrientation(attributeSet);
        }
        attributeSet = context.getInt(C0176R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (attributeSet >= null) {
            setGravity(attributeSet);
        }
        attributeSet = context.getBoolean(C0176R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (attributeSet == null) {
            setBaselineAligned(attributeSet);
        }
        this.mWeightSum = context.getFloat(C0176R.styleable.LinearLayoutCompat_android_weightSum, -1082130432);
        this.mBaselineAlignedChildIndex = context.getInt(C0176R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = context.getBoolean(C0176R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(context.getDrawable(C0176R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = context.getInt(C0176R.styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = context.getDimensionPixelSize(C0176R.styleable.LinearLayoutCompat_dividerPadding, 0);
        context.recycle();
    }
