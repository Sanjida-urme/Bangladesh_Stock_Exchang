...
import android.support.v7.appcompat.C0176R;
...
public final class AppCompatDrawableManager {
    private static final int[] COLORFILTER_COLOR_BACKGROUND_MULTIPLY = new int[]{C0176R.drawable.abc_popup_background_mtrl_mult, C0176R.drawable.abc_cab_background_internal_bg, C0176R.drawable.abc_menu_hardkey_panel_mtrl_mult};
    private static final int[] COLORFILTER_COLOR_CONTROL_ACTIVATED = new int[]{C0176R.drawable.abc_textfield_activated_mtrl_alpha, C0176R.drawable.abc_textfield_search_activated_mtrl_alpha, C0176R.drawable.abc_cab_background_top_mtrl_alpha, C0176R.drawable.abc_text_cursor_material, C0176R.drawable.abc_text_select_handle_left_mtrl_dark, C0176R.drawable.abc_text_select_handle_middle_mtrl_dark, C0176R.drawable.abc_text_select_handle_right_mtrl_dark, C0176R.drawable.abc_text_select_handle_left_mtrl_light, C0176R.drawable.abc_text_select_handle_middle_mtrl_light, C0176R.drawable.abc_text_select_handle_right_mtrl_light};
    private static final int[] COLORFILTER_TINT_COLOR_CONTROL_NORMAL = new int[]{C0176R.drawable.abc_textfield_search_default_mtrl_alpha, C0176R.drawable.abc_textfield_default_mtrl_alpha, C0176R.drawable.abc_ab_share_pack_mtrl_alpha};
    ...
    private static final int[] TINT_CHECKABLE_BUTTON_LIST = new int[]{C0176R.drawable.abc_btn_check_material, C0176R.drawable.abc_btn_radio_material};
    private static final int[] TINT_COLOR_CONTROL_NORMAL = new int[]{C0176R.drawable.abc_ic_commit_search_api_mtrl_alpha, C0176R.drawable.abc_seekbar_tick_mark_material, C0176R.drawable.abc_ic_menu_share_mtrl_alpha, C0176R.drawable.abc_ic_menu_copy_mtrl_am_alpha, C0176R.drawable.abc_ic_menu_cut_mtrl_alpha, C0176R.drawable.abc_ic_menu_selectall_mtrl_alpha, C0176R.drawable.abc_ic_menu_paste_mtrl_am_alpha};
    private static final int[] TINT_COLOR_CONTROL_STATE_LIST = new int[]{C0176R.drawable.abc_tab_indicator_material, C0176R.drawable.abc_textfield_search_material};
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int i) {
        ...
        if (i == C0176R.drawable.abc_cab_background_top_material) {
            cachedDrawable = new LayerDrawable(new Drawable[]{getDrawable(context, C0176R.drawable.abc_cab_background_internal_bg), getDrawable(context, C0176R.drawable.abc_cab_background_top_mtrl_alpha)});
        }
        if (cachedDrawable != null) {
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int i, boolean z, @NonNull Drawable drawable) {
        ...
        if (tintList != null) {
            ...
            return drawable;
        } else if (i == C0176R.drawable.abc_seekbar_track_material) {
            r6 = (LayerDrawable) drawable;
            setPorterDuffColorFilter(r6.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context, C0176R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(r6.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0176R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(r6.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0176R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
        } else {
            if (!(i == C0176R.drawable.abc_ratingbar_material || i == C0176R.drawable.abc_ratingbar_indicator_material)) {
                if (i != C0176R.drawable.abc_ratingbar_small_material) {
            ...
            r6 = (LayerDrawable) drawable;
            setPorterDuffColorFilter(r6.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context, C0176R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(r6.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0176R.attr.colorControlActivated), DEFAULT_MODE);
            setPorterDuffColorFilter(r6.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0176R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
        }
    }
    ...
    static boolean tintDrawableUsingColorFilter(@NonNull Context context, @DrawableRes int i, @NonNull Drawable drawable) {
        ...
        if (arrayContains(COLORFILTER_TINT_COLOR_CONTROL_NORMAL, i)) {
            i2 = C0176R.attr.colorControlNormal;
        } else if (arrayContains(COLORFILTER_COLOR_CONTROL_ACTIVATED, i)) {
            i2 = C0176R.attr.colorControlActivated;
        } else if (arrayContains(COLORFILTER_COLOR_BACKGROUND_MULTIPLY, i)) {
            mode = Mode.MULTIPLY;
        } else {
            if (i == C0176R.drawable.abc_list_divider_mtrl_alpha) {
                i2 = 16842800;
                round = Math.round(1109603123);
                i = 1;
            } else if (i != C0176R.drawable.abc_dialog_material_background) {
                i = 0;
                round = -1;
                i2 = 0;
            }
    ...
    static Mode getTintMode(int i) {
        return i == C0176R.drawable.abc_switch_thumb_material ? Mode.MULTIPLY : 0;
    }
            ...
            if (i == C0176R.drawable.abc_edit_text_material) {
                ...
                if (i != C0176R.drawable.abc_spinner_mtrl_am_alpha) {
                    if (i != C0176R.drawable.abc_spinner_textfield_background_material) {
                        ...
                        } else if (i == C0176R.drawable.abc_seekbar_thumb_material) {
    ...
    private ColorStateList createButtonColorStateList(@NonNull Context context, @ColorInt int i) {
        ...
        context = ThemeUtils.getDisabledThemeAttrColor(context, C0176R.attr.colorButtonNormal);
    ...
    private void checkVectorDrawableSetup(@NonNull Context context) {
        if (!this.mHasCheckedVectorDrawableSetup) {
            ...
            context = getDrawable(context, C0176R.drawable.abc_vector_test);
            if (context != null) {
