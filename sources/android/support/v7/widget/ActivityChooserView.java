...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C01891 extends DataSetObserver {
        C01891() {
        }
    ...
    class C01913 extends AccessibilityDelegate {
        C01913() {
        }
    ...
    class C01925 extends DataSetObserver {
        C01925() {
        }
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            switch (getItemViewType(i)) {
                case 0:
                    if (view == null || view.getId() != C0176R.id.list_item) {
                        view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0176R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    }
                    viewGroup = ActivityChooserView.this.getContext().getPackageManager();
                    ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
                    ((ImageView) view.findViewById(C0176R.id.icon)).setImageDrawable(resolveInfo.loadIcon(viewGroup));
                    ((TextView) view.findViewById(C0176R.id.title)).setText(resolveInfo.loadLabel(viewGroup));
                ...
                case 1:
                    if (view == null || view.getId() != 1) {
                        view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0176R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                        view.setId(1);
                        ((TextView) view.findViewById(C0176R.id.title)).setText(ActivityChooserView.this.getContext().getString(C0176R.string.abc_activity_chooser_view_see_all));
                    }
                    return view;
                default:
                    throw new IllegalArgumentException();
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mModelDataSetObserver = new C01891();
        this.mOnGlobalLayoutListener = new C01902();
        this.mInitialActivityCount = 4;
        attributeSet = context.obtainStyledAttributes(attributeSet, C0176R.styleable.ActivityChooserView, i, 0);
        this.mInitialActivityCount = attributeSet.getInt(C0176R.styleable.ActivityChooserView_initialActivityCount, 4);
        i = attributeSet.getDrawable(C0176R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        attributeSet.recycle();
        LayoutInflater.from(getContext()).inflate(C0176R.layout.abc_activity_chooser_view, this, true);
        this.mCallbacks = new Callbacks();
        this.mActivityChooserContent = (LinearLayoutCompat) findViewById(C0176R.id.activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0176R.id.default_activity_button);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0176R.id.image);
        FrameLayout frameLayout = (FrameLayout) findViewById(C0176R.id.expand_activities_button);
        frameLayout.setOnClickListener(this.mCallbacks);
        frameLayout.setAccessibilityDelegate(new C01913());
        ...
        this.mExpandActivityOverflowButtonImage = (ImageView) frameLayout.findViewById(C0176R.id.image);
        this.mExpandActivityOverflowButtonImage.setImageDrawable(i);
        this.mAdapter = new ActivityChooserViewAdapter();
        this.mAdapter.registerDataSetObserver(new C01925());
        context = context.getResources();
        this.mListPopupMaxWidth = Math.max(context.getDisplayMetrics().widthPixels / 2, context.getDimensionPixelSize(C0176R.dimen.abc_config_prefDialogWidth));
    }
        ...
        if (!i.isShowing()) {
            if (!this.mIsSelectingDefaultActivity) {
                if (z) {
                    ...
                    i.getListView().setContentDescription(getContext().getString(C0176R.string.abc_activitychooserview_choose_application));
