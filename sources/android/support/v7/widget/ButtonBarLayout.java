...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        context = context.obtainStyledAttributes(attributeSet, C0176R.styleable.ButtonBarLayout);
        this.mAllowStacking = context.getBoolean(C0176R.styleable.ButtonBarLayout_allowStacking, z);
        context.recycle();
    }
    ...
    private void setStacked(boolean z) {
        setOrientation(z);
        setGravity(z ? 5 : 80);
        View findViewById = findViewById(C0176R.id.spacer);
