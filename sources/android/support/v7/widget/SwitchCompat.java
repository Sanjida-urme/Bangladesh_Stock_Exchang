...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        attributeSet = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0176R.styleable.SwitchCompat, i, 0);
        this.mThumbDrawable = attributeSet.getDrawable(C0176R.styleable.SwitchCompat_android_thumb);
        if (this.mThumbDrawable != 0) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = attributeSet.getDrawable(C0176R.styleable.SwitchCompat_track);
        if (this.mTrackDrawable != 0) {
            this.mTrackDrawable.setCallback(this);
        }
        this.mTextOn = attributeSet.getText(C0176R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = attributeSet.getText(C0176R.styleable.SwitchCompat_android_textOff);
        this.mShowText = attributeSet.getBoolean(C0176R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = attributeSet.getDimensionPixelSize(C0176R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = attributeSet.getDimensionPixelSize(C0176R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = attributeSet.getDimensionPixelSize(C0176R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = attributeSet.getBoolean(C0176R.styleable.SwitchCompat_splitTrack, false);
        i = attributeSet.getColorStateList(C0176R.styleable.SwitchCompat_thumbTint);
        if (i != 0) {
            this.mThumbTintList = i;
            this.mHasThumbTint = true;
        }
        i = DrawableUtils.parseTintMode(attributeSet.getInt(C0176R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        i = attributeSet.getColorStateList(C0176R.styleable.SwitchCompat_trackTint);
        if (i != 0) {
            this.mTrackTintList = i;
            this.mHasTrackTint = true;
        }
        i = DrawableUtils.parseTintMode(attributeSet.getInt(C0176R.styleable.SwitchCompat_trackTintMode, -1), null);
        ...
        i = attributeSet.getResourceId(C0176R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (i != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        context = TintTypedArray.obtainStyledAttributes(context, i, C0176R.styleable.TextAppearance);
        i = context.getColorStateList(C0176R.styleable.TextAppearance_android_textColor);
        if (i != 0) {
            this.mTextColors = i;
        } else {
            this.mTextColors = getTextColors();
        }
        i = context.getDimensionPixelSize(C0176R.styleable.TextAppearance_android_textSize, 0);
        if (i != 0) {
            i = (float) i;
        ...
        setSwitchTypefaceByIndex(context.getInt(C0176R.styleable.TextAppearance_android_typeface, -1), context.getInt(C0176R.styleable.TextAppearance_android_textStyle, -1));
        if (context.getBoolean(C0176R.styleable.TextAppearance_textAllCaps, false) != 0) {
