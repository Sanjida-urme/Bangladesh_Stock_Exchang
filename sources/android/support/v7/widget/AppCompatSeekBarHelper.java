...
class AppCompatSeekBarHelper extends AppCompatProgressBarHelper {
    ...
    void loadFromAttributes(AttributeSet attributeSet, int i) {
        ...
        attributeSet = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attributeSet, C0176R.styleable.AppCompatSeekBar, i, 0);
        i = attributeSet.getDrawableIfKnown(C0176R.styleable.AppCompatSeekBar_android_thumb);
        if (i != 0) {
            this.mView.setThumb(i);
        }
        setTickMark(attributeSet.getDrawable(C0176R.styleable.AppCompatSeekBar_tickMark));
        if (attributeSet.hasValue(C0176R.styleable.AppCompatSeekBar_tickMarkTintMode) != 0) {
            this.mTickMarkTintMode = DrawableUtils.parseTintMode(attributeSet.getInt(C0176R.styleable.AppCompatSeekBar_tickMarkTintMode, -1), this.mTickMarkTintMode);
            this.mHasTickMarkTintMode = true;
        }
        if (attributeSet.hasValue(C0176R.styleable.AppCompatSeekBar_tickMarkTint) != 0) {
            this.mTickMarkTintList = attributeSet.getColorStateList(C0176R.styleable.AppCompatSeekBar_tickMarkTint);
