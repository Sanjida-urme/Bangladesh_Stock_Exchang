...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class TabView extends LinearLayoutCompat {
        ...
        public TabView(Context context, Tab tab, boolean z) {
            ...
            this.mTab = tab;
            ScrollingTabContainerView obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0176R.attr.actionBarTabStyle, 0);
        ...
        public void update() {
            ...
            if (isEmpty != 0) {
                if (this.mTextView == null) {
                    View appCompatTextView = new AppCompatTextView(getContext(), null, C0176R.attr.actionBarTabTextStyle);
    ...
    private Spinner createSpinner() {
        Spinner appCompatSpinner = new AppCompatSpinner(getContext(), null, C0176R.attr.actionDropDownStyle);
