...
class AppCompatTextViewAutoSizeHelper {
    ...
    void loadFromAttributes(AttributeSet attributeSet, int i) {
        attributeSet = this.mContext.obtainStyledAttributes(attributeSet, C0176R.styleable.AppCompatTextView, i, 0);
        if (attributeSet.hasValue(C0176R.styleable.AppCompatTextView_autoSizeTextType) != 0) {
            this.mAutoSizeTextType = attributeSet.getInt(C0176R.styleable.AppCompatTextView_autoSizeTextType, 0);
        }
        i = attributeSet.hasValue(C0176R.styleable.AppCompatTextView_autoSizeStepGranularity) != 0 ? attributeSet.getDimension(C0176R.styleable.AppCompatTextView_autoSizeStepGranularity, UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE) : -1082130432;
        float dimension = attributeSet.hasValue(C0176R.styleable.AppCompatTextView_autoSizeMinTextSize) ? attributeSet.getDimension(C0176R.styleable.AppCompatTextView_autoSizeMinTextSize, UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE) : UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE;
        float dimension2 = attributeSet.hasValue(C0176R.styleable.AppCompatTextView_autoSizeMaxTextSize) ? attributeSet.getDimension(C0176R.styleable.AppCompatTextView_autoSizeMaxTextSize, UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE) : UNSET_AUTO_SIZE_UNIFORM_CONFIGURATION_VALUE;
        if (attributeSet.hasValue(C0176R.styleable.AppCompatTextView_autoSizePresetSizes)) {
            int resourceId = attributeSet.getResourceId(C0176R.styleable.AppCompatTextView_autoSizePresetSizes, 0);
            if (resourceId > 0) {
