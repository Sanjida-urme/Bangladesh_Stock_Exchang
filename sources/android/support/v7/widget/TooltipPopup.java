...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(C0176R.layout.tooltip, null);
        this.mMessageView = (TextView) this.mContentView.findViewById(C0176R.id.message);
        ...
        this.mLayoutParams.windowAnimations = C0176R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View view, int i, int i2, boolean z, LayoutParams layoutParams) {
        int i3;
        int dimensionPixelOffset = this.mContext.getResources().getDimensionPixelOffset(C0176R.dimen.tooltip_precise_anchor_threshold);
        if (view.getWidth() < dimensionPixelOffset) {
            i = view.getWidth() / 2;
        }
        if (view.getHeight() >= dimensionPixelOffset) {
            dimensionPixelOffset = this.mContext.getResources().getDimensionPixelOffset(C0176R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        dimensionPixelOffset = this.mContext.getResources().getDimensionPixelOffset(z ? C0176R.dimen.tooltip_y_offset_touch : C0176R.dimen.tooltip_y_offset_non_touch);
