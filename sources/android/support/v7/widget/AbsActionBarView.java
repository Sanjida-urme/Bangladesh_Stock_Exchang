...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (context.getTheme().resolveAttribute(C0176R.attr.actionBarPopupTheme, attributeSet, true) == 0 || attributeSet.resourceId == 0) {
    ...
    protected void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, C0176R.styleable.ActionBar, C0176R.attr.actionBarStyle, 0);
        setContentHeight(obtainStyledAttributes.getLayoutDimension(C0176R.styleable.ActionBar_height, 0));
