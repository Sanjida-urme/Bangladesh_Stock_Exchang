...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C02033 implements OnFocusChangeListener {
        C02033() {
        }
    ...
    class C02044 implements OnLayoutChangeListener {
        C02044() {
        }
    ...
    class C02055 implements OnClickListener {
        C02055() {
        }
    ...
    class C02066 implements OnKeyListener {
        C02066() {
        }
    ...
    class C02077 implements OnEditorActionListener {
        C02077() {
        }
    ...
    class C02088 implements OnItemClickListener {
        C02088() {
        }
    ...
    class C02099 implements OnItemSelectedListener {
...
*/
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet, int i) {
            ...
            this.mRunShowSoftInputIfNecessary = new C02111();
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateDrawableStateRunnable = new C02011();
        this.mReleaseCursorRunnable = new C02022();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C02055();
        this.mTextKeyListener = new C02066();
        this.mOnEditorActionListener = new C02077();
        this.mOnItemClickListener = new C02088();
        this.mOnItemSelectedListener = new C02099();
        ...
        attributeSet = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0176R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(attributeSet.getResourceId(C0176R.styleable.SearchView_layout, C0176R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0176R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0176R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0176R.id.search_plate);
        this.mSubmitArea = findViewById(C0176R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0176R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0176R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0176R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0176R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0176R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, attributeSet.getDrawable(C0176R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, attributeSet.getDrawable(C0176R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(attributeSet.getDrawable(C0176R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(attributeSet.getDrawable(C0176R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(attributeSet.getDrawable(C0176R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(attributeSet.getDrawable(C0176R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(attributeSet.getDrawable(C0176R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = attributeSet.getDrawable(C0176R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0176R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = attributeSet.getResourceId(C0176R.styleable.SearchView_suggestionRowLayout, C0176R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = attributeSet.getResourceId(C0176R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C02033());
        setIconifiedByDefault(attributeSet.getBoolean(C0176R.styleable.SearchView_iconifiedByDefault, true));
        context = attributeSet.getDimensionPixelSize(C0176R.styleable.SearchView_android_maxWidth, -1);
        if (context != -1) {
            setMaxWidth(context);
        }
        this.mDefaultQueryHint = attributeSet.getText(C0176R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = attributeSet.getText(C0176R.styleable.SearchView_queryHint);
        context = attributeSet.getInt(C0176R.styleable.SearchView_android_imeOptions, -1);
        if (context != -1) {
            setImeOptions(context);
        }
        context = attributeSet.getInt(C0176R.styleable.SearchView_android_inputType, -1);
        if (context != -1) {
            setInputType(context);
        }
        setFocusable(attributeSet.getBoolean(C0176R.styleable.SearchView_android_focusable, true));
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C02044());
        }
...
*/
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0176R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0176R.dimen.abc_dropdownitem_text_padding_left) : 0;
