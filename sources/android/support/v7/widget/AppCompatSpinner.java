...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
        ...
        public void show() {
            ...
            if (!isShowing) {
                ...
                if (viewTreeObserver != null) {
                    final OnGlobalLayoutListener c01952 = new C01952();
                    viewTreeObserver.addOnGlobalLayoutListener(c01952);
                    setOnDismissListener(new OnDismissListener() {
                        public void onDismiss() {
                            ViewTreeObserver viewTreeObserver = AppCompatSpinner.this.getViewTreeObserver();
                            if (viewTreeObserver != null) {
                                viewTreeObserver.removeGlobalOnLayoutListener(c01952);
                            }
                        }
                    });
                }
    ...
    public AppCompatSpinner(android.content.Context r8, android.util.AttributeSet r9, int r10, int r11, android.content.res.Resources.Theme r12) {
        ...
        r0.<init>();
        r7.mTempRect = r0;
        r0 = android.support.v7.appcompat.C0176R.styleable.Spinner;
        r1 = 0;
    ...
    L_0x001b:
        ...
        goto L_0x003e;
    L_0x0023:
        r12 = android.support.v7.appcompat.C0176R.styleable.Spinner_popupTheme;
    ...
    L_0x007e:
        ...
        r11.<init>(r12, r9, r10);
        r12 = r7.mPopupContext;
        r4 = android.support.v7.appcompat.C0176R.styleable.Spinner;
        r12 = android.support.v7.widget.TintTypedArray.obtainStyledAttributes(r12, r9, r4, r10, r1);
        r1 = android.support.v7.appcompat.C0176R.styleable.Spinner_android_dropDownWidth;
        r4 = -2;
        r1 = r12.getLayoutDimension(r1, r4);
        r7.mDropDownWidth = r1;
        r1 = android.support.v7.appcompat.C0176R.styleable.Spinner_android_popupBackground;
        r1 = r12.getDrawable(r1);
        r11.setBackgroundDrawable(r1);
        r1 = android.support.v7.appcompat.C0176R.styleable.Spinner_android_prompt;
        r1 = r0.getString(r1);
    ...
    L_0x00b4:
        r11 = android.support.v7.appcompat.C0176R.styleable.Spinner_android_entries;
    ...
    L_0x00bc:
        ...
        r12.<init>(r8, r1, r11);
        r8 = android.support.v7.appcompat.C0176R.layout.support_simple_spinner_dropdown_item;
