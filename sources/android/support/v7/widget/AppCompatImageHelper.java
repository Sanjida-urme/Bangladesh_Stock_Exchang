...
public class AppCompatImageHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        attributeSet = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attributeSet, C0176R.styleable.AppCompatImageView, i, 0);
        try {
            i = this.mView.getDrawable();
            if (i == 0) {
                int resourceId = attributeSet.getResourceId(C0176R.styleable.AppCompatImageView_srcCompat, -1);
                if (resourceId != -1) {
            ...
            if (attributeSet.hasValue(C0176R.styleable.AppCompatImageView_tint) != 0) {
                ImageViewCompat.setImageTintList(this.mView, attributeSet.getColorStateList(C0176R.styleable.AppCompatImageView_tint));
            }
            if (attributeSet.hasValue(C0176R.styleable.AppCompatImageView_tintMode) != 0) {
                ImageViewCompat.setImageTintMode(this.mView, DrawableUtils.parseTintMode(attributeSet.getInt(C0176R.styleable.AppCompatImageView_tintMode, -1), null));
            }
