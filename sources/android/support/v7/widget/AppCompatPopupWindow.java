...
class AppCompatPopupWindow extends PopupWindow {
    ...
    private void init(Context context, AttributeSet attributeSet, int i, int i2) {
        context = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0176R.styleable.PopupWindow, i, i2);
        if (context.hasValue(C0176R.styleable.PopupWindow_overlapAnchor) != null) {
            setSupportOverlapAnchor(context.getBoolean(C0176R.styleable.PopupWindow_overlapAnchor, 0));
        }
        setBackgroundDrawable(context.getDrawable(C0176R.styleable.PopupWindow_android_popupBackground));
        attributeSet = VERSION.SDK_INT;
        if (!(i2 == 0 || attributeSet >= 11 || context.hasValue(C0176R.styleable.PopupWindow_android_popupAnimationStyle) == null)) {
            setAnimationStyle(context.getResourceId(C0176R.styleable.PopupWindow_android_popupAnimationStyle, -1));
        }
        context.recycle();
