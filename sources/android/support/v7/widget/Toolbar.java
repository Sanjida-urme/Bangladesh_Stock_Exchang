...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mShowOverflowMenuRunnable = new C02132();
        context = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, C0176R.styleable.Toolbar, i, 0);
        this.mTitleTextAppearance = context.getResourceId(C0176R.styleable.Toolbar_titleTextAppearance, 0);
        this.mSubtitleTextAppearance = context.getResourceId(C0176R.styleable.Toolbar_subtitleTextAppearance, 0);
        this.mGravity = context.getInteger(C0176R.styleable.Toolbar_android_gravity, this.mGravity);
        this.mButtonGravity = context.getInteger(C0176R.styleable.Toolbar_buttonGravity, 48);
        attributeSet = context.getDimensionPixelOffset(C0176R.styleable.Toolbar_titleMargin, 0);
        if (context.hasValue(C0176R.styleable.Toolbar_titleMargins) != 0) {
            attributeSet = context.getDimensionPixelOffset(C0176R.styleable.Toolbar_titleMargins, attributeSet);
        }
        ...
        attributeSet = context.getDimensionPixelOffset(C0176R.styleable.Toolbar_titleMarginStart, -1);
        if (attributeSet >= null) {
            this.mTitleMarginStart = attributeSet;
        }
        attributeSet = context.getDimensionPixelOffset(C0176R.styleable.Toolbar_titleMarginEnd, -1);
        if (attributeSet >= null) {
            this.mTitleMarginEnd = attributeSet;
        }
        attributeSet = context.getDimensionPixelOffset(C0176R.styleable.Toolbar_titleMarginTop, -1);
        if (attributeSet >= null) {
            this.mTitleMarginTop = attributeSet;
        }
        attributeSet = context.getDimensionPixelOffset(C0176R.styleable.Toolbar_titleMarginBottom, -1);
        if (attributeSet >= null) {
            this.mTitleMarginBottom = attributeSet;
        }
        this.mMaxButtonHeight = context.getDimensionPixelSize(C0176R.styleable.Toolbar_maxButtonHeight, -1);
        attributeSet = context.getDimensionPixelOffset(C0176R.styleable.Toolbar_contentInsetStart, Integer.MIN_VALUE);
        int dimensionPixelOffset = context.getDimensionPixelOffset(C0176R.styleable.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
        int dimensionPixelSize = context.getDimensionPixelSize(C0176R.styleable.Toolbar_contentInsetLeft, 0);
        int dimensionPixelSize2 = context.getDimensionPixelSize(C0176R.styleable.Toolbar_contentInsetRight, 0);
        ensureContentInsets();
        ...
        this.mContentInsetStartWithNavigation = context.getDimensionPixelOffset(C0176R.styleable.Toolbar_contentInsetStartWithNavigation, Integer.MIN_VALUE);
        this.mContentInsetEndWithActions = context.getDimensionPixelOffset(C0176R.styleable.Toolbar_contentInsetEndWithActions, Integer.MIN_VALUE);
        this.mCollapseIcon = context.getDrawable(C0176R.styleable.Toolbar_collapseIcon);
        this.mCollapseDescription = context.getText(C0176R.styleable.Toolbar_collapseContentDescription);
        CharSequence text = context.getText(C0176R.styleable.Toolbar_title);
        if (!TextUtils.isEmpty(text)) {
            setTitle(text);
        }
        text = context.getText(C0176R.styleable.Toolbar_subtitle);
        if (!TextUtils.isEmpty(text)) {
            setSubtitle(text);
        }
        this.mPopupContext = getContext();
        setPopupTheme(context.getResourceId(C0176R.styleable.Toolbar_popupTheme, 0));
        Drawable drawable = context.getDrawable(C0176R.styleable.Toolbar_navigationIcon);
        if (drawable != null) {
            setNavigationIcon(drawable);
        }
        text = context.getText(C0176R.styleable.Toolbar_navigationContentDescription);
        if (!TextUtils.isEmpty(text)) {
            setNavigationContentDescription(text);
        }
        drawable = context.getDrawable(C0176R.styleable.Toolbar_logo);
        if (drawable != null) {
            setLogo(drawable);
        }
        text = context.getText(C0176R.styleable.Toolbar_logoDescription);
        if (!TextUtils.isEmpty(text)) {
            setLogoDescription(text);
        }
        if (context.hasValue(C0176R.styleable.Toolbar_titleTextColor) != null) {
            setTitleTextColor(context.getColor(C0176R.styleable.Toolbar_titleTextColor, -1));
        }
        if (context.hasValue(C0176R.styleable.Toolbar_subtitleTextColor) != null) {
            setSubtitleTextColor(context.getColor(C0176R.styleable.Toolbar_subtitleTextColor, -1));
        }
        context.recycle();
    }
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), null, C0176R.attr.toolbarNavigationButtonStyle);
            android.view.ViewGroup.LayoutParams generateDefaultLayoutParams = generateDefaultLayoutParams();
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), null, C0176R.attr.toolbarNavigationButtonStyle);
            ...
            this.mCollapseButtonView.setOnClickListener(new C02143());
        }
    }
