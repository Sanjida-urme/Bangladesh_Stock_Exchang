...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0176R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        context = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0176R.styleable.ActionMode, i, 0);
        ViewCompat.setBackground(this, context.getDrawable(C0176R.styleable.ActionMode_background));
        this.mTitleStyleRes = context.getResourceId(C0176R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = context.getResourceId(C0176R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = context.getLayoutDimension(C0176R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = context.getResourceId(C0176R.styleable.ActionMode_closeItemLayout, C0176R.layout.abc_action_mode_close_item_material);
        context.recycle();
    }
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0176R.layout.abc_action_bar_title_item, this);
            this.mTitleLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0176R.id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0176R.id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode actionMode) {
        ...
        this.mClose.findViewById(C0176R.id.action_mode_close_button).setOnClickListener(new OnClickListener() {
