...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        context = context.getTheme().obtainStyledAttributes(null, C0176R.styleable.DrawerArrowToggle, C0176R.attr.drawerArrowStyle, C0176R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        setColor(context.getColor(C0176R.styleable.DrawerArrowToggle_color, 0));
        setBarThickness(context.getDimension(C0176R.styleable.DrawerArrowToggle_thickness, 0.0f));
        setSpinEnabled(context.getBoolean(C0176R.styleable.DrawerArrowToggle_spinBars, true));
        setGapSize((float) Math.round(context.getDimension(C0176R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0f)));
        this.mSize = context.getDimensionPixelSize(C0176R.styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarLength = (float) Math.round(context.getDimension(C0176R.styleable.DrawerArrowToggle_barLength, 0.0f));
        this.mArrowHeadLength = (float) Math.round(context.getDimension(C0176R.styleable.DrawerArrowToggle_arrowHeadLength, 0.0f));
        this.mArrowShaftLength = context.getDimension(C0176R.styleable.DrawerArrowToggle_arrowShaftLength, 0.0f);
        context.recycle();
    }
