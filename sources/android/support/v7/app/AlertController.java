...
class AlertController {
    ...
    private final OnClickListener mButtonHandler = new C01621();
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            context = context.obtainStyledAttributes(attributeSet, C0176R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = context.getDimensionPixelOffset(C0176R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = context.getDimensionPixelOffset(C0176R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0176R.attr.alertDialogCenterButtons, typedValue, true);
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        context = context.obtainStyledAttributes(null, C0176R.styleable.AlertDialog, C0176R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = context.getResourceId(C0176R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = context.getResourceId(C0176R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = context.getResourceId(C0176R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = context.getResourceId(C0176R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = context.getResourceId(C0176R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = context.getResourceId(C0176R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = context.getBoolean(C0176R.styleable.AlertDialog_showTitle, true);
        context.recycle();
    ...
    private void setupView() {
        View findViewById = this.mWindow.findViewById(C0176R.id.parentPanel);
        View findViewById2 = findViewById.findViewById(C0176R.id.topPanel);
        View findViewById3 = findViewById.findViewById(C0176R.id.contentPanel);
        View findViewById4 = findViewById.findViewById(C0176R.id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById.findViewById(C0176R.id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById5 = viewGroup.findViewById(C0176R.id.topPanel);
        View findViewById6 = viewGroup.findViewById(C0176R.id.contentPanel);
        View findViewById7 = viewGroup.findViewById(C0176R.id.buttonPanel);
        ...
        if (!(z2 || resolvePanel2 == null)) {
            findViewById5 = resolvePanel2.findViewById(C0176R.id.textSpacerNoButtons);
        ...
        if (z) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                findViewById5 = resolvePanel.findViewById(C0176R.id.titleDividerNoCustom);
            }
            if (findViewById5 != null) {
                findViewById5.setVisibility(0);
            }
        } else if (resolvePanel2 != null) {
            findViewById2 = resolvePanel2.findViewById(C0176R.id.textSpacerNoTitle);
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        View findViewById = this.mWindow.findViewById(C0176R.id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0176R.id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0176R.id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0176R.id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0176R.id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0176R.id.scrollView);
