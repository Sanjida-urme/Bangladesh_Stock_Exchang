...
*/
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        attributeSet = context.obtainStyledAttributes(attributeSet, C0176R.styleable.View, 0, 0);
        int resourceId = z ? attributeSet.getResourceId(C0176R.styleable.View_android_theme, 0) : false;
        if (z2 && !resourceId != false) {
            resourceId = attributeSet.getResourceId(C0176R.styleable.View_theme, 0);
            if (resourceId == true) {
