...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02901();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02912();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02753();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C02753 implements ViewPropertyAnimatorUpdateListener {
        C02753() {
        }
    ...
    class C02912 extends ViewPropertyAnimatorListenerAdapter {
        C02912() {
        }
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0176R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0176R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0176R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0176R.id.action_bar_container);
            ...
            if (this.mContainerView != null) {
                ...
                if (!actionBarPolicy.enableHomeButtonByDefault()) {
                    if (view == null) {
                        ...
                        view = this.mContext.obtainStyledAttributes(null, C0176R.styleable.ActionBar, C0176R.attr.actionBarStyle, 0);
                        if (view.getBoolean(C0176R.styleable.ActionBar_hideOnContentScroll, false)) {
                            setHideOnContentScrollEnabled(true);
                        }
                        dimensionPixelSize = view.getDimensionPixelSize(C0176R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0176R.attr.actionBarWidgetTheme, typedValue, true);
