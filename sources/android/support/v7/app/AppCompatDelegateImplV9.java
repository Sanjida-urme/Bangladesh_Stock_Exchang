...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, Factory2 {
    ...
    private final Runnable mInvalidatePanelMenuRunnable = new C01721();
    ...
    class C01735 implements Runnable {
        ...
        class C02871 extends ViewPropertyAnimatorListenerAdapter {
            C02871() {
            }
        ...
        public void run() {
            ...
            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C02871());
                return;
            }
            AppCompatDelegateImplV9.this.mActionModeView.setAlpha(1.0f);
            AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    protected static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            ...
            static class C01741 implements ClassLoaderCreator<SavedState> {
                C01741() {
                }
        ...
        void setStyle(Context context) {
            ...
            context = contextThemeWrapper.obtainStyledAttributes(C0176R.styleable.AppCompatTheme);
            this.background = context.getResourceId(C0176R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = context.getResourceId(C0176R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            context.recycle();
        }
    ...
    class C02712 implements OnApplyWindowInsetsListener {
        C02712() {
        }
    ...
    class C02723 implements OnFitSystemWindowsListener {
        C02723() {
        }
    ...
    class C02734 implements OnAttachListener {
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        class C02891 extends ViewPropertyAnimatorListenerAdapter {
            C02891() {
            }
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C02891());
            }
    ...
    class C02886 extends ViewPropertyAnimatorListenerAdapter {
        C02886() {
        }
        ...
        if (obtainStyledAttributes.hasValue(C0176R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    view = (ViewGroup) from.inflate(C0176R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    view = (ViewGroup) from.inflate(C0176R.layout.abc_screen_simple, null);
                }
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(view, new C02712());
                } else {
                    ((FitWindowsViewGroup) view).setOnFitSystemWindowsListener(new C02723());
                }
            } else if (this.mIsFloating) {
                view = (ViewGroup) from.inflate(C0176R.layout.abc_dialog_title_material, null);
                ...
                view = (ViewGroup) LayoutInflater.from(contextThemeWrapper).inflate(C0176R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) view.findViewById(C0176R.id.decor_content_parent);
            ...
            if (this.mDecorContentParent == null) {
                this.mTitleView = (TextView) view.findViewById(C0176R.id.title);
            }
            ViewUtils.makeOptionalFitsSystemWindows(view);
            ContentFrameLayout contentFrameLayout = (ContentFrameLayout) view.findViewById(C0176R.id.action_bar_activity_content);
            ...
            contentFrameLayout.setAttachListener(new C02734());
            return view;
        }
        obtainStyledAttributes.recycle();
...
*/
    ...
    L_0x0039:
        ...
        r4 = r7.mContext;
        r4 = r4.getTheme();
        r5 = android.support.v7.appcompat.C0176R.attr.actionBarTheme;
    ...
    L_0x0070:
        ...
        r6 = android.support.v7.appcompat.C0176R.attr.actionModePopupWindowStyle;
        r5.<init>(r4, r1, r6);
        ...
        r5.setWidth(r6);
        r5 = r4.getTheme();
        r6 = android.support.v7.appcompat.C0176R.attr.actionBarSize;
    ...
    L_0x00bd:
        r0 = r7.mSubDecor;
        r4 = android.support.v7.appcompat.C0176R.id.action_mode_bar_stub;
