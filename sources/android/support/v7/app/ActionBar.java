...
public abstract class ActionBar {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context context, AttributeSet attributeSet) {
            ...
            this.gravity = 0;
            context = context.obtainStyledAttributes(attributeSet, C0176R.styleable.ActionBarLayout);
            this.gravity = context.getInt(C0176R.styleable.ActionBarLayout_android_layout_gravity, 0);
            context.recycle();
        }
