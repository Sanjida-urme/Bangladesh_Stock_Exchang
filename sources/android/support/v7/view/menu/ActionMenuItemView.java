...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, OnClickListener, ActionMenuChildView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        context = context.obtainStyledAttributes(attributeSet, C0176R.styleable.ActionMenuItemView, i, 0);
        this.mMinWidth = context.getDimensionPixelSize(C0176R.styleable.ActionMenuItemView_android_minWidth, 0);
        context.recycle();
