...
final class StandardMenuPopup extends MenuPopup implements OnDismissListener, OnItemClickListener, MenuPresenter, OnKeyListener {
    ...
    private final OnAttachStateChangeListener mAttachStateChangeListener = new C01822();
    private int mContentWidth;
    private final Context mContext;
    private int mDropDownGravity = 0;
    private final OnGlobalLayoutListener mGlobalLayoutListener = new C01811();
    ...
    class C01811 implements OnGlobalLayoutListener {
        C01811() {
        }
    ...
    class C01822 implements OnAttachStateChangeListener {
    ...
    public StandardMenuPopup(Context context, MenuBuilder menuBuilder, View view, int i, int i2, boolean z) {
        ...
        this.mPopupMaxWidth = Math.max(i.getDisplayMetrics().widthPixels / 2, i.getDimensionPixelSize(C0176R.dimen.abc_config_prefDialogWidth));
        ...
        if (!this.mWasDismissed) {
            if (this.mAnchorView != null) {
                ...
                if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
                    FrameLayout frameLayout = (FrameLayout) LayoutInflater.from(this.mContext).inflate(C0176R.layout.abc_popup_menu_header_item_layout, listView, false);
