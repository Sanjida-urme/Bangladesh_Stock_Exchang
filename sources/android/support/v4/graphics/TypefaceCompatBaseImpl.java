...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C02461 implements StyleExtractor<FontInfo> {
        C02461() {
        }
    ...
    class C02472 implements StyleExtractor<FontFileResourceEntry> {
        C02472() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fontInfoArr, int i) {
        return (FontInfo) findBestFont(fontInfoArr, i, new C02461());
    }
...
*/
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, int i) {
        return (FontFileResourceEntry) findBestFont(fontFamilyFilesResourceEntry.getEntries(), i, new C02472());
    }
