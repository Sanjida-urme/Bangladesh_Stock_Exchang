...
import android.support.mediacompat.C0020R;
...
public class NotificationCompat {
    ...
    public static class MediaStyle extends Style {
        ...
        RemoteViews generateContentView() {
            ...
            applyStandardTemplate.removeAllViews(C0020R.id.media_actions);
            if (i > 0) {
                for (int i2 = 0; i2 < i; i2++) {
                    ...
                    applyStandardTemplate.addView(C0020R.id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(this.mActionsToShowInCompact[i2])));
                }
            }
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0020R.id.end_padder, 8);
                applyStandardTemplate.setViewVisibility(C0020R.id.cancel_action, 0);
                applyStandardTemplate.setOnClickPendingIntent(C0020R.id.cancel_action, this.mCancelButtonIntent);
                applyStandardTemplate.setInt(C0020R.id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0020R.integer.cancel_button_image_alpha));
            } else {
                applyStandardTemplate.setViewVisibility(C0020R.id.end_padder, 0);
                applyStandardTemplate.setViewVisibility(C0020R.id.cancel_action, 8);
            }
        ...
        private RemoteViews generateMediaActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), C0020R.layout.notification_media_action);
            remoteViews.setImageViewResource(C0020R.id.action0, action.getIcon());
            if (obj == null) {
                remoteViews.setOnClickPendingIntent(C0020R.id.action0, action.getActionIntent());
            }
            if (VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0020R.id.action0, action.getTitle());
            }
            return remoteViews;
        }

        int getContentViewLayoutResource() {
            return C0020R.layout.notification_template_media;
        }
        ...
        RemoteViews generateBigContentView() {
            ...
            if (min > 0) {
                for (int i = 0; i < min; i++) {
                    applyStandardTemplate.addView(C0020R.id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0020R.id.cancel_action, 0);
        ...
        int getBigContentViewLayoutResource(int i) {
            return i <= 3 ? C0020R.layout.notification_template_big_media_narrow : C0020R.layout.notification_template_big_media;
        }
    }
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        int getContentViewLayoutResource() {
            if (this.mBuilder.getContentView() != null) {
                return C0020R.layout.notification_template_media_custom;
            }
        ...
        int getBigContentViewLayoutResource(int i) {
            return i <= 3 ? C0020R.layout.notification_template_big_media_narrow_custom : C0020R.layout.notification_template_big_media_custom;
        }
        ...
        private void setBackgroundColor(RemoteViews remoteViews) {
            ...
            if (this.mBuilder.getColor() != 0) {
                ...
                color = this.mBuilder.mContext.getResources().getColor(C0020R.color.notification_material_background_media_default_color);
            }
            remoteViews.setInt(C0020R.id.status_bar_latest_event_content, "setBackgroundColor", color);
        }
    }
