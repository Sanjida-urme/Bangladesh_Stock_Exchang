...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C00961();
    ...
    static class C00961 implements Creator<PlaybackStateCompat> {
        C00961() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C00971();
        ...
        static class C00971 implements Creator<CustomAction> {
            C00971() {
            }
