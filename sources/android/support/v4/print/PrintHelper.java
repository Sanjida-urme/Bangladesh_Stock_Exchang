...
*/
        ...
        public void printBitmap(String str, Uri uri, OnPrintFinishCallback onPrintFinishCallback) throws FileNotFoundException {
            ...
            final Uri uri2 = uri;
            final OnPrintFinishCallback onPrintFinishCallback2 = onPrintFinishCallback;
            PrintDocumentAdapter c01043 = new PrintDocumentAdapter() {
                private PrintAttributes mAttributes;
                Bitmap mBitmap = null;
                        ...
                        this.mLoadBitmap = new AsyncTask<Uri, Boolean, Bitmap>() {
                            ...
                            class C01021 implements OnCancelListener {
                                ...
                                public void onCancel() {
                                    C01043.this.cancelLoad();
                                    C01031.this.cancel(false);
                                }
                            }

                            protected void onPreExecute() {
                                cancellationSignal2.setOnCancelListener(new C01021());
                            }
...
*/
                                /*
                                r1 = this;
                                r2 = android.support.v4.print.PrintHelper.PrintHelperApi19.C01043.this;	 Catch:{ FileNotFoundException -> 0x000d }
                                r2 = android.support.v4.print.PrintHelper.PrintHelperApi19.this;	 Catch:{ FileNotFoundException -> 0x000d }
                                r0 = android.support.v4.print.PrintHelper.PrintHelperApi19.C01043.this;	 Catch:{ FileNotFoundException -> 0x000d }
                            ...
                            protected void onPostExecute(Bitmap bitmap) {
                                ...
                                if (bitmap != null && (!PrintHelperApi19.this.mPrintActivityRespectsOrientation || PrintHelperApi19.this.mOrientation == 0)) {
                                    MediaSize mediaSize;
                                    synchronized (this) {
                                        mediaSize = C01043.this.mAttributes.getMediaSize();
                                    }
            ...
            if (this.mOrientation != 1) {
                if (this.mOrientation != 0) {
                    ...
                    printManager.print(str, c01043, onPrintFinishCallback.build());
                }
            }
