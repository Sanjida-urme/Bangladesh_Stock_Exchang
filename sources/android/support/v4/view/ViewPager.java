...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01321();
    ...
    private static final Interpolator sInterpolator = new C01332();
    ...
    private final Runnable mEndScrollRunnable = new C01343();
    ...
    class C02654 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C01351 implements ClassLoaderCreator<SavedState> {
            C01351() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02654());
    }
