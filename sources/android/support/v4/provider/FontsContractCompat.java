...
public class FontsContractCompat {
    ...
    private static final Comparator<byte[]> sByteArrayComparator = new C01165();
    ...
    static class C01165 implements Comparator<byte[]> {
        C01165() {
        }
...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find block by offset: 0x0137 in list [B:8:0x00af]
...
*/
    ...
    public static void requestFont(@NonNull final Context context, @NonNull final FontRequest fontRequest, @NonNull final FontRequestCallback fontRequestCallback, @NonNull Handler handler) {
        ...
        handler.post(new Runnable() {
            ...
            class C01138 implements Runnable {
                C01138() {
                }
