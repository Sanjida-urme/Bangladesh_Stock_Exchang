...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00482();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00471();
    ...
    class C00482 implements OnItemClickListener {
        C00482() {
        }
