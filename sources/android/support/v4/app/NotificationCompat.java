...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (VERSION.SDK_INT >= 16 && VERSION.SDK_INT < 21) {
                if (obj3 != null) {
                    remoteViews.setInt(C0003R.id.notification_background, "setBackgroundResource", C0003R.drawable.notification_bg_low);
                    remoteViews.setInt(C0003R.id.icon, "setBackgroundResource", C0003R.drawable.notification_template_icon_low_bg);
                } else {
                    remoteViews.setInt(C0003R.id.notification_background, "setBackgroundResource", C0003R.drawable.notification_bg);
                    remoteViews.setInt(C0003R.id.icon, "setBackgroundResource", C0003R.drawable.notification_template_icon_bg);
                }
            }
            if (r0.mBuilder.mLargeIcon != null) {
                if (VERSION.SDK_INT >= 16) {
                    remoteViews.setViewVisibility(C0003R.id.icon, 0);
                    remoteViews.setImageViewBitmap(C0003R.id.icon, r0.mBuilder.mLargeIcon);
                } else {
                    remoteViews.setViewVisibility(C0003R.id.icon, 8);
                }
                if (z && r0.mBuilder.mNotification.icon != 0) {
                    dimensionPixelSize = resources.getDimensionPixelSize(C0003R.dimen.notification_right_icon_size);
                    int dimensionPixelSize2 = dimensionPixelSize - (resources.getDimensionPixelSize(C0003R.dimen.notification_small_icon_background_padding) * 2);
                    if (VERSION.SDK_INT >= 21) {
                        remoteViews.setImageViewBitmap(C0003R.id.right_icon, createIconWithBackground(r0.mBuilder.mNotification.icon, dimensionPixelSize, dimensionPixelSize2, r0.mBuilder.getColor()));
                    } else {
                        remoteViews.setImageViewBitmap(C0003R.id.right_icon, createColoredBitmap(r0.mBuilder.mNotification.icon, -1));
                    }
                    remoteViews.setViewVisibility(C0003R.id.right_icon, 0);
                }
            } else if (z && r0.mBuilder.mNotification.icon != 0) {
                remoteViews.setViewVisibility(C0003R.id.icon, 0);
                if (VERSION.SDK_INT >= 21) {
                    remoteViews.setImageViewBitmap(C0003R.id.icon, createIconWithBackground(r0.mBuilder.mNotification.icon, resources.getDimensionPixelSize(C0003R.dimen.notification_large_icon_width) - resources.getDimensionPixelSize(C0003R.dimen.notification_big_circle_margin), resources.getDimensionPixelSize(C0003R.dimen.notification_small_icon_size_as_large), r0.mBuilder.getColor()));
                } else {
                    remoteViews.setImageViewBitmap(C0003R.id.icon, createColoredBitmap(r0.mBuilder.mNotification.icon, -1));
                }
            }
            if (r0.mBuilder.mContentTitle != null) {
                remoteViews.setTextViewText(C0003R.id.title, r0.mBuilder.mContentTitle);
            }
            if (r0.mBuilder.mContentText != null) {
                remoteViews.setTextViewText(C0003R.id.text, r0.mBuilder.mContentText);
                obj = 1;
            } else {
                obj = null;
            }
            ...
            if (r0.mBuilder.mContentInfo != null) {
                remoteViews.setTextViewText(C0003R.id.info, r0.mBuilder.mContentInfo);
                remoteViews.setViewVisibility(C0003R.id.info, 0);
            } else if (r0.mBuilder.mNumber > 0) {
                if (r0.mBuilder.mNumber > resources.getInteger(C0003R.integer.status_bar_notification_info_maxnum)) {
                    remoteViews.setTextViewText(C0003R.id.info, resources.getString(C0003R.string.status_bar_notification_info_overflow));
                } else {
                    remoteViews.setTextViewText(C0003R.id.info, NumberFormat.getIntegerInstance().format((long) r0.mBuilder.mNumber));
                }
                remoteViews.setViewVisibility(C0003R.id.info, 0);
            } else {
                remoteViews.setViewVisibility(C0003R.id.info, 8);
                obj2 = obj;
                z3 = z5;
                if (r0.mBuilder.mSubText != null && VERSION.SDK_INT >= 16) {
                    remoteViews.setTextViewText(C0003R.id.text, r0.mBuilder.mSubText);
                    if (r0.mBuilder.mContentText == null) {
                        remoteViews.setTextViewText(C0003R.id.text2, r0.mBuilder.mContentText);
                        remoteViews.setViewVisibility(C0003R.id.text2, 0);
                        obj3 = 1;
                        if (obj3 != null && VERSION.SDK_INT >= 16) {
                            if (z2) {
                                remoteViews.setTextViewTextSize(C0003R.id.text, 0, (float) resources.getDimensionPixelSize(C0003R.dimen.notification_subtext_size));
                            }
                            remoteViews.setViewPadding(C0003R.id.line1, 0, 0, 0, 0);
                        }
                        if (r0.mBuilder.getWhenIfShowing() != 0) {
                            z4 = z3;
                        } else if (r0.mBuilder.mUseChronometer || VERSION.SDK_INT < 16) {
                            remoteViews.setViewVisibility(C0003R.id.time, 0);
                            remoteViews.setLong(C0003R.id.time, "setTime", r0.mBuilder.getWhenIfShowing());
                        } else {
                            remoteViews.setViewVisibility(C0003R.id.chronometer, 0);
                            remoteViews.setLong(C0003R.id.chronometer, "setBase", r0.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                            remoteViews.setBoolean(C0003R.id.chronometer, "setStarted", true);
                        }
                        remoteViews.setViewVisibility(C0003R.id.right_side, z4 ? 0 : 8);
                        dimensionPixelSize = C0003R.id.line3;
                        if (obj2 == null) {
                            i2 = 8;
                        }
                    ...
                    remoteViews.setViewVisibility(C0003R.id.text2, 8);
                }
                obj3 = null;
                if (z2) {
                    remoteViews.setTextViewTextSize(C0003R.id.text, 0, (float) resources.getDimensionPixelSize(C0003R.dimen.notification_subtext_size));
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0003R.drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0003R.id.notification_main_column);
            remoteViews.addView(C0003R.id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0003R.id.notification_main_column, 0);
            if (VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0003R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0003R.id.title, 8);
            remoteViews.setViewVisibility(C0003R.id.text2, 8);
            remoteViews.setViewVisibility(C0003R.id.text, 8);
        }
    ...
    public static class Action extends android.support.v4.app.NotificationCompatBase.Action {
        @RestrictTo({Scope.LIBRARY_GROUP})
        public static final android.support.v4.app.NotificationCompatBase.Action.Factory FACTORY = new C02421();
        ...
        static class C02421 implements android.support.v4.app.NotificationCompatBase.Action.Factory {
            C02421() {
            }
    ...
    public static final class CarExtender implements Extender {
        ...
        public static class UnreadConversation extends android.support.v4.app.NotificationCompatBase.UnreadConversation {
            static final Factory FACTORY = new C02431();
            ...
            static class C02431 implements Factory {
                C02431() {
                }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            applyStandardTemplate.removeAllViews(C0003R.id.actions);
            if (z && this.mBuilder.mActions) {
                z = Math.min(this.mBuilder.mActions.size(), 3);
                if (z <= false) {
                    for (boolean z3 = false; z3 < z; z3++) {
                        applyStandardTemplate.addView(C0003R.id.actions, generateActionButton((Action) this.mBuilder.mActions.get(z3)));
                    }
                    if (z2) {
                        i = 8;
                    }
                    applyStandardTemplate.setViewVisibility(C0003R.id.actions, i);
                    applyStandardTemplate.setViewVisibility(C0003R.id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), obj != null ? C0003R.layout.notification_action_tombstone : C0003R.layout.notification_action);
            remoteViews.setImageViewBitmap(C0003R.id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0003R.color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0003R.id.action_text, action.title);
            if (obj == null) {
                remoteViews.setOnClickPendingIntent(C0003R.id.action_container, action.actionIntent);
            }
            if (VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0003R.id.action_container, action.title);
            }
            return remoteViews;
        }
    }
