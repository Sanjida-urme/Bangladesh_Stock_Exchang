...
class NotificationCompatApi24 {
    ...
    public static class Builder implements NotificationBuilderWithBuilderAccessor, NotificationBuilderWithActions {
        ...
        public Builder(Context context, Notification notification, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, RemoteViews remoteViews, int i, PendingIntent pendingIntent, PendingIntent pendingIntent2, Bitmap bitmap, int i2, int i3, boolean z, boolean z2, boolean z3, int i4, CharSequence charSequence4, boolean z4, String str, ArrayList<String> arrayList, Bundle bundle, int i5, int i6, Notification notification2, String str2, boolean z5, String str3, CharSequence[] charSequenceArr, RemoteViews remoteViews2, RemoteViews remoteViews3, RemoteViews remoteViews4, int i7) {
            ...
            builder.f11b = deleteIntent.setFullScreenIntent(pendingIntent3, z6).setLargeIcon(bitmap).setNumber(i).setUsesChronometer(z3).setPriority(i4).setProgress(i2, i3, z).setLocalOnly(z4).setExtras(bundle).setGroup(str2).setGroupSummary(z5).setSortKey(str3).setCategory(str).setColor(i5).setVisibility(i6).setPublicVersion(notification2).setRemoteInputHistory(charSequenceArr);
            if (remoteViews5 != null) {
                builder.f11b.setCustomContentView(remoteViews5);
            }
            if (remoteViews6 != null) {
                builder.f11b.setCustomBigContentView(remoteViews6);
            }
            if (remoteViews7 != null) {
                builder.f11b.setCustomHeadsUpContentView(remoteViews7);
            }
            Iterator it = arrayList.iterator();
            while (it.hasNext()) {
                builder.f11b.addPerson((String) it.next());
            }
            builder.mGroupAlertBehavior = i7;
        }

        public void addAction(Action action) {
            NotificationCompatApi24.addAction(this.f11b, action);
        }
