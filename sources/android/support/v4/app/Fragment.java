...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener, LifecycleOwner {
    ...
    class C02402 extends FragmentContainer {
        C02402() {
        }
...
*/
        ...
        if (this.mFragmentManager != null) {
            if (this.mFragmentManager.mHost != null) {
                if (Looper.myLooper() != this.mFragmentManager.mHost.getHandler().getLooper()) {
                    this.mFragmentManager.mHost.getHandler().postAtFrontOfQueue(new C00241());
                    return;
                } else {
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachController(this.mHost, new C02402(), this);
    }
