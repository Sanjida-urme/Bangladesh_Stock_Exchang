...
public class FontResourcesParserCompat {
    ...
    private static FamilyResourceEntry readFamily(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        ...
        int integer2 = obtainAttributes.getInteger(C0003R.styleable.FontFamily_fontProviderFetchTimeout, DEFAULT_TIMEOUT_MILLIS);
    ...
    private static FontFileResourceEntry readFont(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        ...
        int i = resources.getInt(C0003R.styleable.FontFamilyFont_fontWeight, NORMAL_WEIGHT);
        boolean z = true;
        if (1 != resources.getInt(C0003R.styleable.FontFamilyFont_fontStyle, 0)) {
            z = false;
        }
        int resourceId = resources.getResourceId(C0003R.styleable.FontFamilyFont_font, 0);
        String string = resources.getString(C0003R.styleable.FontFamilyFont_font);
        resources.recycle();
        while (xmlPullParser.next() != 3) {
            skip(xmlPullParser);
        }
