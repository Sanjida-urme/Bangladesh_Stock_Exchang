...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C00501();
...
*/
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C02452();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C00501 implements ThreadFactory {
    ...
    class C02452 extends WorkerRunnable<Params, Result> {
        C02452() {
        }
